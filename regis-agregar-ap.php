...
?>
  <div class="wrapper contenido">
    <form id="Formr" class="formulario box" action="php/func-agregar-ap.php"
    method="post" enctype="multipart/form-data">
      ...
      <label class="col-xs-1" for="[edificio]">
        <input class="" type="hidden" name="edificio"
        value='<?php echo intval(preg_replace('/[^0-9]+/', '', $edificio), 10); ?>' required>
      </label>

      <label class="col-xs-1" for="lugar">
        <p>Ubicación</p>
        <textarea class="col-xs-1" name="lugar" rows="4" cols="20" required></textarea>
      </label><br><br>
